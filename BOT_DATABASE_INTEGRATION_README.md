# 🤖 Интеграция базы данных в ForestMafia Bot

## 📋 Описание

База данных успешно интегрирована в бота ForestMafia. Теперь бот работает с PostgreSQL через модуль `database_psycopg2.py` и автоматически сохраняет данные пользователей, игр и статистику.
