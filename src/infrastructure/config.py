...
class GameConfig:
    ...
    min_players_normal: int = int(os.environ.get('MIN_PLAYERS_NORMAL', '6'))
    min_players_test: int = int(os.environ.get('MIN_PLAYERS_TEST', '3'))
    max_players: int = int(os.environ.get('MAX_PLAYERS', '12'))
    
    # Длительность фаз (в секундах)
    night_duration: int = int(os.environ.get('NIGHT_DURATION', '60'))
    day_duration: int = int(os.environ.get('DAY_DURATION', '300'))  # 5 минут
    voting_duration: int = int(os.environ.get('VOTING_DURATION', '120'))  # 2 минуты
...
class LoggingConfig:
    ...
    file_path: str = os.environ.get('LOG_FILE', 'bot.log')
...
class Config:
    ...
    def get_database_settings(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'max_overflow': self._database.max_overflow
        }
