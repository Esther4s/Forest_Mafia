...
**ForestMafia Bot** - это полнофункциональный Telegram бот для игры в "Лес и Волки" (аналог Mafia/Werewolf) с лесной тематикой. Бот поддерживает до 12 игроков, автоматизирует игровой процесс и ведет статистику.
...
**ForestMafia Bot** полностью готов к продакшену и может быть развернут за 5-10 минут на любой поддерживаемой платформе.
