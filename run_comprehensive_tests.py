...
"""
Главный файл для запуска всех комплексных тестов системы Лес и волки
...
def main():
    """Главная функция"""
    print("🌲 Лес и волки Bot - Комплексное тестирование системы 🌲")
    print("=" * 80)
    ...
    try:
        ...
        with open('test_summary.txt', 'w', encoding='utf-8') as f:
            f.write(f"Лес и волки Bot - Результаты комплексного тестирования\n")
