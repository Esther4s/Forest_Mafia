...
🎮 Раунд: {self.game.current_round}
    ...
    def get_game_over_message(self, result: Dict, nuts_info: str = "") -> str:
        ...
        if winner == Team.PREDATORS:
            victory_message = "<b>На Лес опустилась тьма… Хищники похитили всех зверей и победили.</b>"
        else:
            victory_message = "<b>Лесные жители ликуют! Наконец-то им удалось изгнать всех хищников из их уютного Леса! Победа!</b>"
        
        message = f"""
🌲 <b>ИГРА ЗАВЕРШЕНА!</b> 🌲

{emoji} <b>Победители: {team_name}</b> {emoji}
