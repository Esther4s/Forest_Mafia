# Отчет о рефакторинге ForestMafia Bot

## Обзор

Проведен полный рефакторинг кода ForestMafia Bot согласно принципам чистого кода. Код был разбит на модули, улучшены имена переменных и методов, упрощена логика, устранено дублирование.
